...
| rowRenderer         | func                    | function which returns the row contents for this row, [more information available](https://github.com/bencripps/react-redux-grid/blob/master/docs/USING_CUSTOM_ROW_RENDERERS.md)|
